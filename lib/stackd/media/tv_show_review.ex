defmodule Stackd.Media.TvShowReview do
  use Ash.Resource,
    domain: Stackd.Media,
  ...
  postgres do
    table "tv_show_reviews"
    repo Stackd.Repo

    references do
      reference :user, on_delete: :delete
      reference :tv_show, on_delete: :delete
      reference :tv_show_log, on_delete: :delete
    end
  ...
  actions do
    ...
    create :create do
      accept [:tv_show_id, :tv_show_log_id, :content, :rating, :spoiler]
  ...
  relationships do
    ...
    belongs_to :tv_show_log, Stackd.Media.TvShowLog do
      allow_nil? true
    end
  end
